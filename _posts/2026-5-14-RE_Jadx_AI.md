...
החלטתי ללכת על גישת ההנדסה לאחור, לערוך ברמת הSMALI. כדי להבין טוב יותר מה קורה בSMALI, משתמשים בכלי בשם JADX שמפרק את הקוד לJAVA (אפשר ללמוד יותר על עריכת APK במאמר [הזה](https://digitalwhisper.co.il/files/Zines/0xB4/DW180-1-AndroidFirmwareModification.pdf) שכתבתי.) - אבל הקוד הזה, כמו שידוע לכל מי שמתעסק בתחום, יוצא שבור. הוא יעיל מאוד לצרכי מחקר והבנה של האפליקציה, אבל לא ניתן לקימפול. JADX לא עושה עבודה מושלמת...
