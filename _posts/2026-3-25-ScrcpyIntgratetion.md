...
אפליקציה שמוגדרת כמקלדת במכשיר (צריך כמובן להפעיל ולהגדיר אותה בהגדרות), מקבלת את הKeyEvent שScrcpy שולח כדי להקליד - ואם נבחרה עברית, מקלידה את האות המקבילה לKeyEvent הזה (בםריסה סטנדרטית).
